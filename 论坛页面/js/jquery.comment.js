(function($){
	function crateCommentInfo(obj){
		...
		var el = "<div class='comment-info'><header></header><div class='comment-right'><h3 style='color: #009688'>标题："+obj.replyName+"</h3>"
				+"<div class='comment-content-header'><span><i class='layui-icon layui-icon-date'></i>"+obj.time+"</span>";
		...
		el = el + "</div><div class=' layui-col-md-offset11'><span class='reply-btn layui-btn'>评论</span></div></div></div><div class='reply-list'>";
	...
	function createReplyComment(reply){
		var replyEl = "<div class='reply'><div><a href='javascript:void(0)' class='replyname'>"+reply.replyName+"</a>:<span>"+reply.content+"</span></div>"
						+ "<p><span>"+reply.time+"</span> <span class='reply-list-btn layui-icon layui-icon-dialogue '>回复</span></p></div>";
		return replyEl;
	}
	...
	function replyClick(el){
		el.parent().parent().append("<div class='replybox'><textarea cols='80' rows='50' placeholder='来说几句吧......' class='mytextarea' ></textarea><span class='send layui-btn layui-btn-sm 'style='float: right'>发送</span></div>")
